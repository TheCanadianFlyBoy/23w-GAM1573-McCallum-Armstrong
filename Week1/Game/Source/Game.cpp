    ...
    : GameCore( fwCore )
{
    ...
    m_pMeshes["InvertedSprite"] = CreateInvertedSpriteMesh();
    m_pMeshes["StarDavid"] = CreateStarDavidMesh();
    ...
    m_pPlayer = new Player( this, m_pController, "Player", vec3(6,5,0), m_pMeshes["InvertedSprite"], m_pMaterials["MegaMan"] );
    ...
    m_Objects.push_back( new fw::GameObject( this, "Object 2", vec3(10,10,0), m_pMeshes["StarDavid"], m_pMaterials["Blue"] ) );
